                ...
                <Card className="CasesTotal" onClick={() => this.setState({showList: !this.state.showList})} style={{height: this.props.mobile ? "200px" : "160px", backgroundColor: "#2A2A28", marginBottom: this.props.mobile ? "0" : "30px"}}>
                    <div>
                        <ThemeProvider theme={coco}>
                            <Typography style={{fontSize: this.props.mobile ? "3vh" : "2vh", color: 'white'}}>Total confirmed: </Typography>
                            <Typography style={{fontSize: this.props.mobile ? "8vh" : "3vh", color: '#9D1C19', fontWeight: 'bold', marginTop: '7px'}} variant="h3">{this.state.totalConfirmed}</Typography>
                        </ThemeProvider>
                    </div>
                </Card>
